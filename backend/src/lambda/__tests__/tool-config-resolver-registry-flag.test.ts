/**
 * Tests for feature flag check and Registry Service initialization (task 7.1)
 *
 * Validates: Requirements 11.1, 11.2, 11.3, 11.5
 */
import { isRegistryEnabled, getRegistryService, _resetRegistryService } from '../tool-config-resolver';
...
describe('feature flag and registry service initialization (tool resolver)', () => {
