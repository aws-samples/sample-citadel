...
export function validateProjectInput(rawInput: unknown): void {
  ...
  if (input.requirements && input.requirements.length > 5000) {
    throw new ValidationError(
      "Requirements must be less than 5000 characters",
      "requirements",
    );
  }
}
...
export function validateS3Object(rawS3Object: unknown): void {
  ...
  if (!s3Object.bucket || typeof s3Object.bucket !== "string") {
    throw new ValidationError(
      "S3 bucket is required and must be a string",
      "bucket",
    );
  }
  ...
  if (!s3Object.region || typeof s3Object.region !== "string") {
    throw new ValidationError(
      "S3 region is required and must be a string",
      "region",
    );
  }
...
export function validateARN(arn: string, arnType: "lambda" | "iam-role"): void {
  if (!arn || typeof arn !== "string") {
    throw new ValidationError(
      `${arnType === "lambda" ? "Lambda" : "IAM Role"} ARN is required and must be a string`,
      "arn",
    );
  }
...
export function validateToolSchemaJSON(jsonString: string): void {
  if (!jsonString || typeof jsonString !== "string") {
    throw new ValidationError(
      "Tool schema is required and must be a string",
      "toolSchema",
    );
  }
  ...
  if (!schema.name || typeof schema.name !== "string") {
    throw new ValidationError(
      'Tool schema must include "name" field',
      "toolSchema",
    );
  }
  ...
  if (!schema.description || typeof schema.description !== "string") {
    throw new ValidationError(
      'Tool schema must include "description" field',
      "toolSchema",
    );
  }
  ...
  if (schema.inputSchema.type !== "object") {
    throw new ValidationError(
      'Tool schema inputSchema must be of type "object"',
      "toolSchema",
    );
  }
}
...
export function validateHTTPSUrl(url: string): void {
  if (!url || typeof url !== "string") {
    throw new ValidationError(
      "MCP Server URL is required and must be a string",
      "serverUrl",
    );
  }
