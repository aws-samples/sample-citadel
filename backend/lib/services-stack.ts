...
`),
      ...
      const agentIntakeSingleRuntime = new agentcore.Runtime(this, 'AgentIntakeSingleRuntime', {
        ...
        environmentVariables: {
          ...
          AGENT_MODEL: process.env.AGENT_MODEL || 'us.anthropic.claude-sonnet-4-6',
          EXTRACTION_MODEL: process.env.EXTRACTION_MODEL || 'us.anthropic.claude-haiku-4-5-20251001-v1:0',
          LANGFUSE_SECRET_KEY: '',
          LANGFUSE_PUBLIC_KEY: '',
          LANGFUSE_BASE_URL: '',
        },
