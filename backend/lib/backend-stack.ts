...
export class BackendStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: BackendStackProps) {
    ...
    // App Resolver Lambda
    const appResolverFunction = new lambda.Function(
      this,
      'AppResolverFunction',
      {
        runtime: lambda.Runtime.NODEJS_24_X,
        ...
        timeout: cdk.Duration.seconds(30),
        logGroup: new logs.LogGroup(this, 'AppResolverFunctionLogs', { retention: logs.RetentionDays.ONE_WEEK, removalPolicy: cdk.RemovalPolicy.DESTROY }),
      }
    );

    // App Resolver IAM — least-privilege per design 8.2
    this.appsTable.grantReadWriteData(appResolverFunction);
    this.workflowsTable.grantReadWriteData(appResolverFunction);
    this.agentConfigTable.grantReadData(appResolverFunction);
    this.agentEventBus.grantPutEventsTo(appResolverFunction);
    appResolverFunction.addToRolePolicy(
      new iam.PolicyStatement({
        effect: iam.Effect.ALLOW,
        actions: ['cognito-idp:AdminGetUser'],
        resources: [this.userPool.userPoolArn],
    ...
    const appLambdaDataSource = this.appSyncApi.addLambdaDataSource(
      'AppLambdaDataSource',
      appResolverFunction
    );
    ...
    appLambdaDataSource.createResolver('GetAppResolver', {
      typeName: 'Query',
      fieldName: 'getApp',
      requestMappingTemplate: appsync.MappingTemplate.lambdaRequest(),
      responseMappingTemplate: appsync.MappingTemplate.lambdaResult(),
    ...
    appLambdaDataSource.createResolver('ListAppsResolver', {
      typeName: 'Query',
      fieldName: 'listApps',
      requestMappingTemplate: appsync.MappingTemplate.lambdaRequest(),
      responseMappingTemplate: appsync.MappingTemplate.lambdaResult(),
    ...
    appLambdaDataSource.createResolver('CreateAppResolver', {
      typeName: 'Mutation',
      fieldName: 'createApp',
      requestMappingTemplate: appsync.MappingTemplate.lambdaRequest(),
      responseMappingTemplate: appsync.MappingTemplate.lambdaResult(),
    ...
    appLambdaDataSource.createResolver('UpdateAppResolver', {
      typeName: 'Mutation',
      fieldName: 'updateApp',
      requestMappingTemplate: appsync.MappingTemplate.lambdaRequest(),
      responseMappingTemplate: appsync.MappingTemplate.lambdaResult(),
    ...
    appLambdaDataSource.createResolver('DeleteAppResolver', {
      typeName: 'Mutation',
      fieldName: 'deleteApp',
      requestMappingTemplate: appsync.MappingTemplate.lambdaRequest(),
      responseMappingTemplate: appsync.MappingTemplate.lambdaResult(),
    ...
    appLambdaDataSource.createResolver('BindWorkflowToAppResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('UnbindWorkflowFromAppResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('UpdateAgentBindingResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('AddAppComponentResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('RemoveAppComponentResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('SetAppConfigSchemaResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('SetAppConfigValuesResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('PublishAppStatusEventResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('CreateAppApiKeyResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('RevokeAppApiKeyResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('RotateAppApiKeyResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('ListAppApiKeysResolver', {
      typeName: 'Query',
    ...
    appLambdaDataSource.createResolver('SetAppAuthConfigResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('GrantAppAccessResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('RevokeAppAccessResolver', {
      typeName: 'Mutation',
    ...
    appLambdaDataSource.createResolver('ListAppAccessEntriesResolver', {
      typeName: 'Query',
    ...
    // Metrics resolver
    appLambdaDataSource.createResolver('GetAppMetricsResolver', {
      typeName: 'Query',
