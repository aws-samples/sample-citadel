...
SAMPLE_WORKFLOW = {
    ...
    'definition': json.dumps({
        'nodes': [
            {'id': 'n0', 'type': 'agent', 'data': {'agentId': 'agent-A', 'label': 'Node A'}},
            {'id': 'n1', 'type': 'agent', 'data': {'agentId': 'agent-B', 'label': 'Node B'}},
            {'id': 'n2', 'type': 'agent', 'data': {'agentId': 'agent-C', 'label': 'Node C'}},
        ],
        'edges': [
...
PARALLEL_WORKFLOW = {
    ...
    'definition': json.dumps({
        'nodes': [
            {'id': 'n0', 'type': 'agent', 'data': {'agentId': 'agent-A', 'label': 'Root'}},
            {'id': 'n1', 'type': 'agent', 'data': {'agentId': 'agent-B', 'label': 'Branch 1'}},
            {'id': 'n2', 'type': 'agent', 'data': {'agentId': 'agent-C', 'label': 'Branch 2'}},
            {'id': 'n3', 'type': 'agent', 'data': {'agentId': 'agent-D', 'label': 'Merge'}},
        ],
        'edges': [
            {'id': 'e0', 'source': 'n0', 'target': 'n1'},
...
CONDITIONAL_WORKFLOW = {
    ...
    'definition': json.dumps({
        'nodes': [
            {'id': 'n0', 'type': 'agent', 'data': {'agentId': 'agent-A', 'label': 'Root'}},
            {'id': 'n1', 'type': 'agent', 'data': {'agentId': 'agent-B', 'label': 'Approved Path'}},
            {'id': 'n2', 'type': 'agent', 'data': {'agentId': 'agent-C', 'label': 'Default Path'}},
        ],
        'edges': [
