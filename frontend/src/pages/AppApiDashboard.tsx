                      ...
                      <td className="py-2 px-3">
                        <div className="flex items-center gap-2">
                          ...
                          <Button
                            ...
                            className="size-auto h-auto p-0 text-muted-foreground hover:text-foreground hover:bg-transparent transition-colors"
            ...
            <div className="flex items-center gap-1 bg-accent rounded-lg p-1">
              {TIME_RANGES.map((range) => (
                <Button
                  ...
                  className={cn(
                    'px-3 py-1 h-auto text-xs rounded-md transition-colors',
