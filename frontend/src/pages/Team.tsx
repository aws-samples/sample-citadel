...
export function Team() {
  ...
  return (
    <PageContainer className="flex-1 bg-card">
                ...
                <div className="flex flex-col gap-3">
                  {displayedLobbyUsers.map((user) => {
                    ...
                    return (
                      <Card
                        key={user.userId}
                        className="flex-row items-center justify-between gap-0 p-4 hover:border-chart-4/50 transition-colors"
                      >
            ...
            <CardContent>
              <div className="flex flex-col gap-3">
                {displayedActiveUsers.length > 0 ? (
                  ...
                  <Card
                    key={user.userId}
                    className="gap-0 hover:border-primary transition-colors"
                  >
                                ...
                                <AccordionContent>
                                  <div className="flex flex-col gap-4 pt-2">
                                    ...
                                    <Select
                                      ...
                                      onValueChange={setNewOrganizationValue}
                                    >
                                      <SelectTrigger className="w-full">
                                        <SelectValue placeholder="Select a new organization..." />
                                      </SelectTrigger>
                                      <SelectContent>
                                        {organizations.filter(o => o.name !== user.organization).map(org => (
                                          <SelectItem key={org.orgId} value={org.name}>{org.name}</SelectItem>
                                        ))}
                                      </SelectContent>
                                    </Select>
                                    <Button
          ...
          <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={setNewUserOrganization}
                  disabled={creatingUser}
                >
                  <SelectTrigger className="w-full">
                  ...
                  <SelectContent>
                    {organizations.map((org) => (
                      <SelectItem key={org.orgId} value={org.name}>
                        {org.name}
                      </SelectItem>
                    ))}
                  </SelectContent>
      ...
      <Dialog open={showManageOrgsModal} onOpenChange={setShowManageOrgsModal}>
        <DialogContent className="bg-accent border-border max-w-2xl max-h-[80vh] overflow-hidden flex flex-col gap-0 p-0">
          <DialogHeader className="p-6 pb-4">
            <div className="flex items-center justify-between">
              ...
              <Button
                size="sm"
                className="bg-primary text-primary-foreground hover:bg-primary/90 mr-8"
