...
import { filterAppsBySearch, filterAppsByStatus } from '../appFilters';
...
const appStatusArb = fc.constantFrom<'DRAFT' | 'ACTIVE' | 'ARCHIVED'>('DRAFT', 'ACTIVE', 'ARCHIVED');

const appItemArb: fc.Arbitrary<AppItem> = fc.record({
  appId: fc.uuid(),
