...
export const AgentNode = memo(({ id, data, selected }: NodeProps<AgentNodeData>) => {
  ...
  return (
    ...
    >
      ...
      {selected && (
        <Card 
          className="absolute -top-10 right-0 flex-row gap-1 bg-accent rounded-md p-1 shadow-lg animate-in fade-in slide-in-from-top-2 duration-200"
          role="toolbar"
        ...
        >
          <Button
            ...
            variant="ghost"
            size="icon"
            className="size-7 p-1.5 rounded text-muted-foreground hover:bg-accent hover:text-primary hover:scale-110 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400"
            title="Configure"
          ...
          <Button
            ...
            variant="ghost"
            size="icon"
            className="size-7 p-1.5 rounded text-muted-foreground hover:bg-accent hover:text-destructive hover:scale-110 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-red-400"
            title="Delete"
