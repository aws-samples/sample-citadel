...
export function ChartRow2Skeleton() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-5" data-testid="chart-row-2-skeleton">
      {[0, 1, 2].map((i) => (
        <Card key={i} className="rounded-lg p-5 gap-0">
          <div className="mb-4">
 ...
 * Matches: flex gap-6 mt-5, each card with chart height 300px + metrics
 */
export function ChartRow3Skeleton() {
  return (
    <div className="flex gap-6 mt-5" data-testid="chart-row-3-skeleton">
      {[0, 1].map((i) => (
        <Card key={i} className="w-1/2 rounded-lg p-5 gap-0">
          <div className="mb-4">
 ...
 * Matches: grid grid-cols-1 lg:grid-cols-2 gap-4 mt-5 (two responsive cards) + full-width quick actions
 */
  ...
  return (
    <div data-testid="chart-row-4-skeleton">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-5">
        {[0, 1].map((i) => (
          <Card key={i} className="bg-accent rounded-lg p-5 gap-0">
            <div className="mb-6">
      ...
      <Card className="rounded-lg p-5 mt-5 gap-0">
        <div className="mb-4">
