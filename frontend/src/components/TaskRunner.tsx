              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[200px] px-4 py-3 bg-card border border-border rounded-lg text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none resize-y"
                    disabled={loading}
                  />
                ...
                <div>
                  ...
                  <select
                    id="callbackType"
                    value={callbackType}
                    onChange={(e) => setCallbackType(e.target.value as 'eventbridge' | 'sqs' | 'mcp')}
                    className="w-full px-4 py-3 bg-card border border-border rounded-lg text-foreground focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none"
                    disabled={loading}
                  >
                    <option value="eventbridge">EventBridge</option>
                    <option value="sqs">SQS Queue</option>
                    <option value="mcp">MCP Webhook</option>
                  </select>
                  <p className="mt-2 text-xs text-muted-foreground">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-card border border-border rounded-lg text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none"
                    disabled={loading}
                  />
                  <p className="mt-2 text-xs text-muted-foreground">
