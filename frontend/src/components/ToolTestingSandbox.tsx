        ...
        {hasSchema ? (
            ...
            {Object.entries(schema).map(([fieldName, fieldDef]: [string, any]) => (
              <div key={fieldName}>
                ...
                <input
                  ...
                  className="w-full px-2 py-1 text-sm bg-background border border-input rounded text-foreground placeholder-slate-600"
                />
              </div>
            ))}
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-2 py-1 text-sm bg-background border border-input rounded text-foreground placeholder-slate-600 font-mono"
            />
          </div>
        )}
