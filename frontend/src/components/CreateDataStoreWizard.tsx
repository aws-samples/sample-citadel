                  ...
                  {types.map(({ type, meta }) => {
                    ...
                    return (
                      <Button
                        ...
                        className={`h-auto justify-start whitespace-normal items-center gap-2.5 p-3 rounded-lg text-left ${
                          isSelected
                            ? 'bg-primary/10 border-primary hover:bg-primary/10'
                            : 'bg-accent hover:border-input'
                        }`}
                      >
                        <div
        ...
        {step === 2 && selectedMeta && (
          <div className="flex flex-col gap-3">
            <Button
              ...
              className={`h-auto w-full justify-start whitespace-normal items-start gap-4 p-4 rounded-lg text-left ${
                provisionMode === DataStoreProvisionMode.CREATE_NEW
                  ? 'bg-primary/10 border-primary hover:bg-primary/10'
                  : 'bg-accent hover:border-input'
              }`}
              ...
              {getConfigFields().map((field) => (
                <div key={field.key}>
                  ...
                  {field.type === 'select' && field.options ? (
                    ...
                    >
                      <SelectTrigger id={`cfg-${field.key}`} className="mt-1 w-full">
