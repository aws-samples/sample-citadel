    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              variant="outline"
              className="gap-2 px-4 py-2 rounded-md font-medium inline-flex items-center transition-colors duration-200 bg-white text-black border-none cursor-pointer text-sm h-[38px] hover:bg-muted"
