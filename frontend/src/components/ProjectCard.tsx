      ...
      <CardContent className="flex flex-col gap-3">
        {project.progress && (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
            <StatusCard status={project.progress.assessment == 100 ? "completed" : "in_progress"} className="bg-background rounded-lg p-4">
            ...
            <StatusCard status={project.progress.assessment == 100 ? (project.progress.planning == 100 ? "completed" : "in_progress") : "pending"} className={cn('bg-background rounded-lg p-4', project.progress.assessment < 100 && 'opacity-60')}>
              <div className="flex items-center gap-2 mb-3">
              ...
              <Button 
                  ...
                  className="w-full text-xs disabled:cursor-not-allowed">
                Status & Details
              </Button>
            </StatusCard>

            <StatusCard status={project.progress.planning == 100 ? (project.progress.implementation == 100 ? "completed" : "in_progress") : "pending"} className={cn('bg-background border border-border rounded-lg p-4', project.progress.planning < 100 && 'opacity-60')}>
              <div className="flex items-center gap-2 mb-3">
                <div className="size-6 rounded bg-primary/10 flex items-center justify-center">
