...
export function ExecutionHistoryPanel({ workflowId, isOpen, onClose }: ExecutionHistoryPanelProps) {
  ...
  return (
    <div data-testid="execution-history-panel" className="border-l bg-white w-80 p-4 overflow-y-auto">
      ...
      {nextToken && (
        <button
          className="mt-3 w-full py-1.5 text-sm text-primary border border-primary rounded hover:bg-primary/10"
